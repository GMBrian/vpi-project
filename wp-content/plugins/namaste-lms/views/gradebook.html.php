<div class="wrap">
   ...
   <?php endif;?>
	...
	<?php if(!empty($this_course->ID)):?>
		<?php if(!$in_shortcode):?>
		<p><?php _e('View-only shortcode for this gradebook:', 'namaste');?> <input type="text" value='[namaste-gradebook course_id="<?php echo $this_course->ID?>"]' size="25" onclick="this.select();" readonly="readonly"></p>
		...
		<table class="widefat namaste-table namaste-gradebook">
			...
			<tr><?php foreach($lessons as $lesson):?><th><?php echo stripslashes($lesson->post_title)?></th><?php endforeach;?></tr>
