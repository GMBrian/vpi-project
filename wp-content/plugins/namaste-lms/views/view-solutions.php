...
<div class="wrap">
	...
	$class = ('alternate' == @$class) ? '' : 'alternate';?>
		...
		<?php endif;?></tr>
		<tr class="<?php echo $class?>"><td><?php echo apply_filters('the_content', stripslashes($solution->content));?>
		<?php if(!empty($solution->file)):?>
			<p><?php _e('Attachment:', 'namaste')?> <a href="<?php echo admin_url('admin.php?page=namaste_download_solution&id='.$solution->id.'&noheader=1')?>"><?php echo $solution->file?></a></p>
		<?php endif;?></td>
