<div class="wrap">
   ...
   <form method="post">
      ...
      <p><input type="checkbox" name="status" value="1" <?php if(!empty($_POST['status'])) echo 'checked'?>> <?php _e('Include status column.', 'namaste');?> <br>
      ...
      <p><?php _e('List tag:', 'namaste')?><select name="list_tag">
