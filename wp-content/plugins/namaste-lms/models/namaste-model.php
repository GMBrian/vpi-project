...
class NamasteLMS {
   static function install($update = false) {
   	...
   	update_option( 'namaste_version', "1.42");
   	if(!$update) self::init();
   ...
   static function menu() {   	  	
   	...
   	add_menu_page(__('Namaste! LMS', 'namaste'), __('Namaste! LMS', 'namaste'), "namaste_manage", "namaste_options", 
   	...
   	add_submenu_page('namaste_options', __("To Do", 'namaste'), __("To Do", 'namaste'), 'namaste_manage', 'namaste_todo', array('NamasteToDo', "manager_todo"));	
		...
		add_submenu_page( NULL, __("Mass enroll students", 'namaste'), __("Mass enroll students", 'namaste'), 'namaste_manage', 'namaste_mass_enroll', array('NamasteLMSCoursesController', "mass_enroll"));
	...
	static function init() {
		...
		if($version != '1.42') self::install(true);
